# 1 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
# 1 "/home/user/Osek/Test-LDR/erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
# 53 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
...
# 54 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c" 2
...
# 55 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c" 2
...
# 56 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c" 2
# 1 "/home/user/Osek/Test-LDR/erika/inc/ee_get_kernel_and_core.h" 1
# 57 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c" 2
...
# 235 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
...

      {
        ...
        osEE_lock_core(p_cdb);
# 288 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
...
# 343 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
      ev = E_OK;
...
# 450 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
  return ev;
}
...
# 498 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
    if (p_tdb_act->task_type <= OSEE_TASK_TYPE_EXTENDED) {
      OsEE_reg const flags = osEE_begin_primitive();
...
# 540 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
  return ev;
}
...
)
{
  ...
  OsEE_TDB * const
    p_curr = p_ccb->p_curr;
# 598 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
  {
    OsEE_reg const
...
# 622 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
...
# 651 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
...
# 682 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
  osEE_orti_trace_service_exit(p_ccb, OSServiceId_Schedule);

  return ev;
}
# 862 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
StatusType
  ShutdownOS
(
  StatusType Error
...
{
  StatusType ev;
# 926 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
  if (TaskID == 
# 926 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c" 3 4
               ((void *)0)
# 926 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
                   ) {
    ...
    if (p_tdb->task_type <= OSEE_TASK_TYPE_EXTENDED) {
      ...
      while (p_sn != 
# 943 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c" 3 4
                    ((void *)0)
# 943 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
                        ) {
        OsEE_TDB const * const
...
# 980 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
  return ev;
}
...
)
{
  StatusType ev;
  OsEE_KDB * const p_kdb = osEE_get_kernel();
# 1003 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
  if (State == 
# 1003 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c" 3 4
              ((void *)0)
# 1003 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
                  ) {
    ev = E_OS_PARAM_POINTER;
...
# 1060 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
  return ev;
}
...
# 1101 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
    {
      OsEE_reg const
        flags = osEE_begin_primitive();
...
# 1136 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
  return ev;
}
...
)
{
  ...
  } else
  {
    ...
    OsEE_CounterDB * const
      p_counter_db = osEE_alarm_get_trigger_db(p_alarm_db)->p_counter_db;
# 1175 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
    {
      OsEE_reg const
        flags = osEE_begin_primitive();
...
# 1210 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
  return ev;
}
...
# 1262 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
  return ev;
}
...
)
{
  ...
  if (Tick == 
# 1284 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c" 3 4
             ((void *)0)
# 1284 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
                 ) {
    ev = E_OS_PARAM_POINTER;
  } else
  {
...
# 1321 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
  return ev;
}
...
)
{
  ...
  if (Info == 
# 1343 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c" 3 4
             ((void *)0)
# 1343 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
                 ) {
    ev = E_OS_PARAM_POINTER;
  } else
  {
...
# 1382 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
  return ev;
}
# 1839 "/home/user/Osek/Test-LDR/erika/src/ee_oo_api_osek.c"
ISRType
  GetISRID
(
  void
