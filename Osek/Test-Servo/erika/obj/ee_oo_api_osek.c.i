# 1 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
# 1 "/media/sf_SharedFolder/Osek/Test-Servo/erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
# 53 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
...
# 54 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c" 2
...
# 55 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c" 2
...
# 56 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c" 2
# 1 "/media/sf_SharedFolder/Osek/Test-Servo/erika/inc/ee_get_kernel_and_core.h" 1
# 57 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c" 2
...
# 235 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
...

      {
        ...
        osEE_lock_core(p_cdb);
# 288 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
...
# 343 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
      ev = E_OK;
...
# 450 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
  return ev;
}
...
# 498 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
    if (p_tdb_act->task_type <= OSEE_TASK_TYPE_EXTENDED) {
      OsEE_reg const flags = osEE_begin_primitive();
...
# 540 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
  return ev;
}
...
)
{
  ...
  OsEE_TDB * const
    p_curr = p_ccb->p_curr;
# 598 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
  {
    OsEE_reg const
...
# 622 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
...
# 651 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
...
# 682 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
  osEE_orti_trace_service_exit(p_ccb, OSServiceId_Schedule);

  return ev;
}
# 862 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
StatusType
  ShutdownOS
(
  StatusType Error
...
{
  StatusType ev;
# 926 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
  if (TaskID == 
# 926 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c" 3 4
               ((void *)0)
# 926 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
                   ) {
    ...
    if (p_tdb->task_type <= OSEE_TASK_TYPE_EXTENDED) {
      ...
      while (p_sn != 
# 943 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c" 3 4
                    ((void *)0)
# 943 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
                        ) {
        OsEE_TDB const * const
...
# 980 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
  return ev;
}
...
)
{
  StatusType ev;
  OsEE_KDB * const p_kdb = osEE_get_kernel();
# 1003 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
  if (State == 
# 1003 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c" 3 4
              ((void *)0)
# 1003 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
                  ) {
    ev = E_OS_PARAM_POINTER;
...
# 1060 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
  return ev;
}
...
# 1101 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
    {
      OsEE_reg const
        flags = osEE_begin_primitive();
...
# 1136 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
  return ev;
}
...
)
{
  ...
  } else
  {
    ...
    OsEE_CounterDB * const
      p_counter_db = osEE_alarm_get_trigger_db(p_alarm_db)->p_counter_db;
# 1175 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
    {
      OsEE_reg const
        flags = osEE_begin_primitive();
...
# 1210 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
  return ev;
}
...
# 1262 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
  return ev;
}
...
)
{
  ...
  if (Tick == 
# 1284 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c" 3 4
             ((void *)0)
# 1284 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
                 ) {
    ev = E_OS_PARAM_POINTER;
  } else
  {
...
# 1321 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
  return ev;
}
...
)
{
  ...
  if (Info == 
# 1343 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c" 3 4
             ((void *)0)
# 1343 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
                 ) {
    ev = E_OS_PARAM_POINTER;
  } else
  {
...
# 1382 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
  return ev;
}
...
# 1446 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
...
# 1493 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
...
)
{
  ...
  OsEE_KDB * const
    p_kdb = osEE_get_kernel();
# 1547 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
  if (!osEE_is_valid_tid(p_kdb, TaskID)) {
    ev = E_OS_ID;
  } else {
    OsEE_TDB * const
...
# 1574 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
    {
...
# 1619 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
  return ev;
}
...
)
{
  ...
  OsEE_KDB * const
    p_kdb = osEE_get_kernel();
# 1676 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
  if (!osEE_is_valid_tid(p_kdb, TaskID)) {
    ev = E_OS_ID;
  } else
  {
...
# 1694 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
    if (Event == 
# 1694 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c" 3 4
                ((void *)0)
# 1694 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
                    ) {
      ev = E_OS_PARAM_POINTER;
...
# 1723 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
  return ev;
}
...
# 1771 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
  {
...
# 1791 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
  osEE_orti_trace_service_exit(p_ccb, OSServiceId_ClearEvent);

  return ev;
}
# 1839 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_api_osek.c"
ISRType
  GetISRID
(
  void
