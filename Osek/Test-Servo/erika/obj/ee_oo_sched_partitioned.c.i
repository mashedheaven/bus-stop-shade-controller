# 1 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_sched_partitioned.c"
# 1 "/media/sf_SharedFolder/Osek/Test-Servo/erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_sched_partitioned.c"
# 54 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_sched_partitioned.c"
...
# 55 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_sched_partitioned.c" 2
...
# 121 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_sched_partitioned.c"
...
)
{
  ...
  osEE_unlock_core(p_cdb);
# 232 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_sched_partitioned.c"
  ...
  osEE_lock_core(p_cdb);
  {
    ...
    if (p_tcb_term->status == OSEE_TASK_RUNNING) {
...

      {
        ...
        if (p_prev == 
# 308 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_sched_partitioned.c" 3 4
                     ((void *)0)
# 308 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_sched_partitioned.c"
                         ) {
...
)
{
  ...
  if (p_prev != 
# 344 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_sched_partitioned.c" 3 4
               ((void *)0)
# 344 "/media/sf_SharedFolder/Osek/Test-Servo/erika/src/ee_oo_sched_partitioned.c"
                   ) {
    OsEE_TDB * const p_curr = p_ccb->p_curr;
