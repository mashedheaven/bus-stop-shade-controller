 ...
 *
 **************************************************************************/
extern ALARMCALLBACK(task1_alarm_callback);
...
{
  {
    /* .tdb_ptr_array = */    &tdb_ptr_autostart_ModeIncrement,
    /* .tdb_array_size  = */  OSEE_ARRAY_ELEMENT_COUNT(tdb_ptr_autostart_ModeIncrement)
  },
  {
    /* .tdb_ptr_array = */    NULL,
    /* .tdb_array_size  = */  (0U)
...
VAR(OsEE_AlarmDB, OS_CONST)
  alarm_db_array[OSEE_ALARMS_ARRAY_SIZE] = {
  {
    ...
    /* .action       = */ {
      /* .param      = */   {
        /* .f            = */ &task1_alarm_callback,
        /* .p_tdb        = */ NULL,
        /* .p_counter_db = */ NULL},
      /* .type       = */ OSEE_ACTION_CALLBACK
    }
  }
};
...
{
  {
    /* .tdb_ptr_array = */    &trigger_autostart_info_ModeIncrement,
    /* .tdb_array_size  = */  OSEE_ARRAY_ELEMENT_COUNT(trigger_autostart_info_ModeIncrement)
  },
  {
    /* .tdb_ptr_array = */    &trigger_autostart_info_ModeDecrement,
    /* .tdb_array_size  = */  OSEE_ARRAY_ELEMENT_COUNT(trigger_autostart_info_ModeDecrement)
  },
  {
