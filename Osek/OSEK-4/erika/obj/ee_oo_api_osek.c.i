# 1 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
# 1 "/home/user/Osek/OSEK-4/erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
# 53 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
...
# 54 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c" 2
...
# 55 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c" 2
...
# 56 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c" 2
# 1 "/home/user/Osek/OSEK-4/erika/inc/ee_get_kernel_and_core.h" 1
# 57 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c" 2
...
# 235 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
...

      {
        ...
        osEE_lock_core(p_cdb);
# 288 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
...
# 343 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
      ev = E_OK;
...
# 486 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c" 3 4
                                  ((void *)0)
# 486 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
                                      ) {
...
# 573 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
  if ((p_curr->task_type >= OSEE_TASK_TYPE_ISR2)
  ...
  if (p_curr_tcb->p_first_mtx != 
# 584 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c" 3 4
                                ((void *)0)
# 584 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
                                    ) {
...
# 646 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c" 3 4
                           ((void *)0)
# 646 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
                               ) {
    ev = E_OS_RESOURCE;
  } else
...
)
{
  ...
  } else
  {
...

    {
      ...
      if (p_tcb->p_first_mtx != 
# 809 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c" 3 4
                               ((void *)0)
# 809 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
                                   ) {
        TaskPrio const
...
{
  StatusType ev;
# 926 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
  if (TaskID == 
# 926 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c" 3 4
               ((void *)0)
# 926 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
                   ) {
    ...
    if (p_tdb->task_type <= OSEE_TASK_TYPE_EXTENDED) {
      ...
      while (p_sn != 
# 943 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c" 3 4
                    ((void *)0)
# 943 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
                        ) {
        OsEE_TDB const * const
...
)
{
  StatusType ev;
  OsEE_KDB * const p_kdb = osEE_get_kernel();
# 1003 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
  if (State == 
# 1003 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c" 3 4
              ((void *)0)
# 1003 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
                  ) {
    ev = E_OS_PARAM_POINTER;
...
)
{
  ...
  if (Tick == 
# 1284 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c" 3 4
             ((void *)0)
# 1284 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
                 ) {
    ev = E_OS_PARAM_POINTER;
  } else
  {
...
)
{
  ...
  if (Info == 
# 1343 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c" 3 4
             ((void *)0)
# 1343 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
                 ) {
    ev = E_OS_PARAM_POINTER;
  } else
  {
...
# 1416 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
  ...
  if (p_curr_tcb->p_first_mtx != 
# 1430 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c" 3 4
                                ((void *)0)
# 1430 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
                                    ) {
...
# 1530 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
...
# 1657 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
  if (osEE_check_disableint(p_ccb)) {
    ev = E_OS_DISABLEDINT;
  } else
  if ((p_curr->task_type > OSEE_TASK_TYPE_ISR2)
  ...
  } else
  {
    ...
    if (Event == 
# 1694 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c" 3 4
                ((void *)0)
# 1694 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
                    ) {
      ev = E_OS_PARAM_POINTER;
    } else
    {
...
# 1754 "/home/user/Osek/OSEK-4/erika/src/ee_oo_api_osek.c"
  if (osEE_check_disableint(p_ccb)) {
    ev = E_OS_DISABLEDINT;
  } else
  if ((p_curr->task_type >= OSEE_TASK_TYPE_ISR2)
